...
Smawfield, M. L. 2025h, *Universal Critical Density: Unifying Atomic, Galactic, and Compact Object Scales via the Temporal Equivalence Principle*, Zenodo, DOI: 10.5281/zenodo.18064366 (Paper 7: Universal Scaling / Companion Paper)

Smawfield, M. L. 2025i, *The Soliton Wake: A Runaway Black Hole as a Gravitational Soliton*, Zenodo, DOI: 10.5281/zenodo.18059251 (Paper 8: This Work)
...
#### Key Analysis Outputs
        ...
        - `site/figures/figure_01_rbh1_observation.png` — Observation schematic

        - `site/figures/figure_02_sensitivity.png` — Falsification sensitivity

        - `site/figures/figure_03_universal_scaling.png` — Soliton scaling law
